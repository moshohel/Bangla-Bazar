                  ...
                  <div class="product-image">
                    ...
                    @foreach ($product->images as $image)
                        @if ($i == 1 )
                            <div class="product_img_box">
                                <img id="product_img" src="{!! asset('images/'.$image->image) !!}" data-zoom-image="assets/images/product_zoom_img1.jpg" alt="product_img1" />
                    ...
                    @endforeach
                        ...
                        <div id="pr_item_gallery" class="product_gallery_item slick_slider" data-slides-to-show="4" data-slides-to-scroll="1" data-infinite="false">
                            ...
                            @foreach ($product->images as $image)
                                <div class="item">
                                    <a href="#" class="product_gallery_item active" data-image="{!! asset('images/'.$image->image) !!}" data-zoom-image="{!! asset('images/'.$image->image) !!}">
                                        <img src="{!! asset('images/'.$image->image) !!}" alt="product_small_img1" />
                                    </a>
                                </div>
                            @php $i++; @endphp
                            @endforeach
                    ...
                    <div class="tab-style3">
                        <ul class="nav nav-tabs" role="tablist">
                            <li class="nav-item">
                              ...
                              <li class="nav-item">
                                <a class="nav-link active" id="Reviews-tab" data-toggle="tab" href="#Reviews" role="tab" aria-controls="Reviews" aria-selected="true">Reviews (2)</a>
                              </li>
                        </ul>
