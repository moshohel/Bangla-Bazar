  ...
  <link href={{asset("assets/admin/plugins/flag-icons/css/flag-icon.min.css")}} rel="stylesheet" />
  <link href={{asset("assets/admin/plugins/jvectormap/jquery-jvectormap-2.0.3.css")}} rel="stylesheet" />
  <link href={{asset("assets/admin/plugins/ladda/ladda.min.css")}} rel="stylesheet" />
