  ...
  <script src={{asset("assets/admin/plugins/slimscrollbar/jquery.slimscroll.min.js")}}></script>
  ...
  <script src={{asset("assets/admin/plugins/jquery-mask-input/jquery.mask.min.js")}}></script>
  ...
  <script src={{asset("assets/admin/plugins/jekyll-search.min.js")}}></script>
